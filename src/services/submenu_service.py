...
class SubMenuService:
    ...
    def get_list_submenus(self, api_test_menu_id) -> list[Any]:
    ...
    def get_one_submenu(self, api_test_menu_id, api_test_submenu_id) -> dict:
    ...
    def post_submenu(self, api_test_menu_id, submenu_items) -> dict:
    ...
    def patch_submenu(self, api_test_menu_id, api_test_submenu_id, submenu_items) -> dict:
    ...
    def delete_submenu(self, api_test_menu_id, api_test_submenu_id) -> dict:
